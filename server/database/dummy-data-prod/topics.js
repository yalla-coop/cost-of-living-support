...
const addTopics = async ({ sections }) => {
  ...
  const payingForHousingPrivateTenantTopic2 = await createTopics({
    ...
    content: {
      ...
      tip1: `You can check if you're likely to receive support by using a benefit calculator. 
      It's free to use and usually takes 10-20 minutes. 
  ...
  const payingForHousingPrivateTenantTopic3 = await createTopics({
    ...
    content: {
      ...
      tip1: `You can prepare for debt advice by gathering together all the information you have about money coming in and money going out. But don't delay seeking help - even if you don't have everything to hand, the sooner you get help the better.`,
  ...
  const payingForHousingHomeownerTopic1 = await createTopics({
    ...
    content: {
      ...
      tip1: "Read letters from your mortgage provider and speak to them on the phone if they call you. They'll look for ways to offer you help and support, and advise you about the steps you can take.",
  ...
  const payingForHousingHomeownerTopic2 = await createTopics({
    ...
    content: {
      ...
      tip1: `You can check if you're likely to receive additional support by using a benefit calculator. 
  ...
  const payingMyBillsTopic1 = await createTopics({
    ...
    content: {
      ...
      tip1: 'Some utility providers have grants that customers who are struggling to pay their bills can access. Ask about this when you speak to them.',
  ...
  const payingMyBillsTopic2 = await createTopics({
    ...
    content: {
      ...
      tip1: `There are many different grants out there, the best way to find out if you're eligible is to use a free grant search tool. Also remember to ask your utility provider if they have grants available. `,
  ...
  const payingMyBillsTopic3 = await createTopics({
    ...
    content: {
      ...
      It's free to use and usually takes 10-20 minutes. 
      You will need to input basic information about your income and living situation.`,
      tip2: `If you're receiving certain benefits, like Universal Credit, you may be able to access additional financial support from your local council. 
  ...
  const payingMyBillsTopic4 = await createTopics({
    ...
    content: {
      ...
      tip1: `Using a price comparison website is a good way to quickly check if you can save money by switching provider.`,
  ...
  const payingForEssentialsTopic1 = await createTopics({
    ...
    content: {
      ...
      tip1: "If you're pregnant or have a child under 4, and you are receiving certain benefits , you may be eligible for a Health Start Card, which entitles you to help with purchasing milk, fruit and vegetables. If you're in receipt of benefits, any school age children may be eligible for free school meals.",
  ...
  const payingForEssentialsTopic3 = await createTopics({
    ...
    content: {
      ...
      tip1: `There are many different grants out there, the best way to find out if you're eligible is to use a free grant search tool.`,
      tip2: `Receiving a charitable grant will in most cases not affect your benefit entitlement. If you're offered a grant, you should seek advice about your situation.`,
      resources: [
        {
          type: 'CUSTOM',
  ...
  const payingForEssentialsTopic4 = await createTopics({
    ...
    content: {
      ...
      tip1: `Because the assessment is slightly different you may be eligible for help with health costs even if your income is too high for other types of benefits.`,
  ...
  const dealingWithDebtsTopic2 = await createTopics({
    ...
    content: {
      ...
      tip1: `When doing your budget be as honest and accurate as possible. Put down what you actually spend, as opposed to what you think you should or could spend. By creating an accurate budget you get the best possible starting point for talking to your creditors, or receiving money or debt advice. `,
  ...
  const dealingWithDebtsTopic3 = await createTopics({
    ...
    content: {
      ...
      tip1: `The Bill Prioritiser is an excellent tool that can help you prioritise all your bills if you're unsure which ones you should deal with first. A debt advisor will also be able to help you prioritise.`,
      tip2: `If you're working with a debt advisor, you may be able to access 'Breathing Space' which pauses debt collection and evictions for up to 60 days to give you time to find the right solution.`,
      resources: [
        {
          type: 'EXTERNAL',
  ...
  const dealingWithDebtsTopic4 = await createTopics({
    ...
    content: {
      ...
      tip1: `If you've received a letter from your creditor saying that they'll take action to recover a debt, please don't let this stop you from contacting them. Their priority when you get in touch is to help you find a solution to deal with the debt.`,
  ...
  const dealingWithDebtsTopic5 = await createTopics({
    ...
    content: {
      ...
      tip1: `Make sure you include all debts. Some examples include:
      Rent or mortgage arrears
      Credit card or loan debts
      Council tax arrears and unpaid fines or taxes
      Energy or water bills 
      Money borrowed from family or friends`,
      tip2: `By taking this first important step, you're on your way to finding a solution to dealing with your debts. 
  ...
  const maximisingYourIncomeTopic4 = await createTopics({
    ...
    content: {
      ...
      tip1: `Your local library is often a great resource for finding out about services and activities that you can access at low or no cost in your local area. Libraries usually also provide free internet access and can provide help with finding information on line. `,
